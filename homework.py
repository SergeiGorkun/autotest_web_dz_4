...
if __name__ == '__main__':
    ...
    # извините - совершенно не успеваю нормально выполнять домашние задания...
    # дипломом нас тут мучают...примите пожалуйста работу. это наша последняя домашняя работа) спасибо за уроки!
